<template>
    <v-card class="addForm">
        <v-select class="addForm__select" v-model="category" label="Category" :items="categories"></v-select>
        <v-text-field class="addForm__input" v-model="value" label="Value"></v-text-field>
        <v-text-field class="addForm__input" v-model="date" label="Date"></v-text-field>
        <v-btn class="addForm__btn" color="teal" dark @click="onAddClick">Add</v-btn>
    </v-card>
</template>
