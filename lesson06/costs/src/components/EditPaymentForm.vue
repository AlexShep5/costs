<template>
    <div v-show="visible" class="form">
        <select class="form__select" name="category" v-model="category" @focus="onChangeCategory">
        ...
        <div class="form__buttons">
            ...
            <button class="form__btn" @click="onApplyClick">APPLY</button>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        onChangeCategory() {
            const elm = this.container.querySelector('.form__select')
            elm.classList.add('form__select_blackText')
        }
